...
<div class=" container projectsPost">
    ...
    <div id="gallery_photoswipe" class="row" itemscope itemtype="http://schema.org/ImageGallery">
        <?php
        if (have_rows('photos')):
            while (have_rows('photos')) : the_row();
                ...
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-12 col-md-6">
                    <a href="<?= $subField['url'] ?>" data-caption="<?= $subField['alt'] ?>" data-width="1920" data-height="1080" data-large="<?= $subField['sizes']['large'] ?>" itemprop="contentUrl">
